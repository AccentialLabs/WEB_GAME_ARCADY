...
<div class="col-xs-2 col-lateral-menu">
    ...
    <ul class="nav nav-tabs tabs-left">
        <li class="active"><a href="#infos" data-toggle="tab" class="menu-tab"><span class="glyphicon glyphicon-exclamation-sign"></span> Infos</a></li>
        <li><a href="#jogadores" data-toggle="tab" class="menu-tab"><span class="glyphicon glyphicon-user"></span> Jogadores</a></li>
        <li><a href="#interacoes" data-toggle="tab" class="menu-tab"><span class="glyphicon glyphicon-hand-right"></span> Interações</a></li>
        <li><a href="#reconhecimentos" data-toggle="tab" class="menu-tab"><span class="glyphicon glyphicon-asterisk"></span> Reconhec.</a></li>
        <li><a href="#premios" data-toggle="tab" class="menu-tab menu-tab-premios"><span class="glyphicon glyphicon-gift"></span> Prêmios</a></li>
